...
# django-auth-ldap
# urls
LDAP_DOMAIN = env.str("AUTH_LDAP_DOMAIN", default="dc=amarena,dc=ovh")
...
AUTH_LDAP_SERVER_URI = env.str(
    "AUTH_LDAP_SERVER_URI", default="ldap://ldap.amarena.ovh"
)
...
AUTH_LDAP_USER_SEARCH = LDAPSearch(
    f"ou=people,{LDAP_DOMAIN}", ldap.SCOPE_SUBTREE, "(mail=%(user)s)"
)
